...
func (b *LesApiBackend) SendBundle(ctx context.Context, txs types.Transactions, blockNumber rpc.BlockNumber, ethertbaseProfit *big.Int, minTimestamp uint64, maxTimestamp uint64) error {
