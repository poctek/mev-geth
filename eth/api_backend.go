...
func (b *EthAPIBackend) SendBundle(ctx context.Context, txs types.Transactions, blockNumber rpc.BlockNumber, etherbaseProfit *big.Int, minTimestamp uint64, maxTimestamp uint64) error {
